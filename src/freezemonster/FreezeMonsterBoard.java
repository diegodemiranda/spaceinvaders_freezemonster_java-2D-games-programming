...
public class FreezeMonsterBoard extends AbstractBoard{
    ...
    protected void createBadSprites() {
        ...
        for (int k = 0; k < numMonstros; k++) {
            String path = "/Users/diegodemiranda/IdeaProjects/TrabalhoFinal/images/monster" + (k + 1) + ".png";
            String path2 = "/Users/diegodemiranda/IdeaProjects/TrabalhoFinal/images/monster" + (k + 1) + "bg.png";
            lastTime[k] = 0;
